...
class MyFrame(wx.Frame):
    ...
    def setup_tab4(self):
        ...
        self.tab4_sizer.Add(self.tab4_row1, 0, wx.EXPAND | wx.TOP | wx.BOTTOM, 5)

        self.tab4_row2 = wx.BoxSizer(wx.HORIZONTAL)
        self.tab4_row2.Add(self.check_for_updates_button, 0, wx.ALL, 5)
        self.tab4_sizer.Add(self.tab4_row2, 0, wx.EXPAND | wx.TOP | wx.BOTTOM, 5)
        ...
        self.tab4_sizer.Add(self.tab4_row3, 0, wx.EXPAND | wx.TOP | wx.BOTTOM, 5)
