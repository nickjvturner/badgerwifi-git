...
class MyFrame(wx.Frame):
    ...
    def setup_tab2(self):
        ...
        self.tab2_sizer.Add(self.tab2_row2_sizer, 0, wx.EXPAND | wx.TOP | wx.BOTTOM, self.edge_margin)
        ...
        self.tab2_sizer.Add(self.tab2_row3_sizer, 0, wx.EXPAND | wx.TOP | wx.BOTTOM, self.edge_margin)
