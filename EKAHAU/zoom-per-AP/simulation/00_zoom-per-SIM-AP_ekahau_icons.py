...
def get_y_offset(arrow, angle):
    arrow_length = arrow.height / 1.4
    default_y_offset = arrow.height / 2.6
            ...
            for floor in floorPlans['floorPlans']:
                ...
                for ap in sorted(accessPoints['accessPoints'], key=lambda i: i['name']):
                    ...
                    if ap['location']['floorPlanId'] == floor['id']:
                        ...
                        x1 = crop_size - edge_buffer - text_width - (text_rect_offset * 2)
                        y1 = edge_buffer - (text_rect_offset * 2)

                        x2 = crop_size - edge_buffer + text_rect_offset
                        y2 = edge_buffer + text_height + text_rect_offset
                        ...
                        y1 = y + y_offset - (text_height / 2) - text_rect_offset

                        x2 = x + (text_width / 2) + text_rect_offset
                        y2 = y + y_offset + (text_height / 2) + text_rect_offset
                        ...
                        # draw the AP Name
                        draw_all_APs.text((x, y + y_offset + 2), ap['name'], anchor='mm', fill='black', font=font)
